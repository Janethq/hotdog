  ...
  return (
    ...
    >
      <MapContainer center={mapCenter} zoom={zoom}>
        ...
        />
        <Marker icon={defaultIcon} position={[1.3505233, 103.9243734]}>
          <Popup>
            <span>{serviceNames[0]}</span> <br />
            <span>{serviceAddresses[0]}</span>
          </Popup>
        </Marker>
        <Marker icon={defaultIcon} position={[1.2933872, 103.8545593]}>
          <Popup>
            <span>{serviceNames[1]}</span> <br />
            <span>{serviceAddresses[1]}</span>
          </Popup>
        </Marker>
        <Marker icon={defaultIcon} position={[1.3131482, 103.8970243]}>
          <Popup>
            <span>{serviceNames[2]}</span> <br />
            <span>{serviceAddresses[2]}</span>
          </Popup>
        </Marker>
        <Marker icon={defaultIcon} position={[1.3528162, 103.9370613]}>
          <Popup>
            <span>{serviceNames[3]}</span> <br />
            <span>{serviceAddresses[3]}</span>
          </Popup>
        </Marker>
        <Marker icon={defaultIcon} position={[1.3180642, 103.8959215]}>
          <Popup>
            <span>{serviceNames[4]}</span> <br />
            <span>{serviceAddresses[4]}</span>
          </Popup>
        </Marker>
        <Marker icon={defaultIcon} position={[1.3441277, 103.7321283]}>
          <Popup>
